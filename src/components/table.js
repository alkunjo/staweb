...
class EnhancedTable extends React.Component {
  ...
  render() {
    const { classes, rows, allowCheck, useToolbar } = this.props;
    ...
    return (
      <Paper className={classes.root}>
        {useToolbar && <EnhancedTableToolbar numSelected={selected.length} />}
                ...
                .map(n => {
                  ...
                  return (
                    <TableRow
                      hover
                      onClick={event => {
                        if (allowCheck) this.handleCheck(event, n.id);
                      }}
                      role="checkbox"
